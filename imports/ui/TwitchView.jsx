...
export const TwitchView = () => {
    ...
    const updateText = () => {
        ...
        setMiddleText(text[counter]);
        setFadeIn(true);
    }

    const fadeInOut = () => {
        setFadeIn(false);
        Meteor.setTimeout(() => updateText(),1100);
    }

    useEffect(() => {
        setMiddleText(text[counter]);
        Meteor.setInterval(fadeInOut, 10000);
    }, [])



    const text = [<h2 className='white-text mb-0 halloween'>Live DJ Set</h2>,
        <img src='/images/dj_logo.png' className='img-fluid py-1 halloween-shadow-invert' alt='Di Gio Dj Logo'/>,
        <h3 className='text-white mb-0 halloween'>Doneren? Dat kan! koornbeurs.nl/doneer</h3>];

    return [
        <div key="1" className="p-1" style={{position: "absolute", bottom: "60px", left: 0, zIndex: 1040}}>
            <svg className="ghost halloween-shadow" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                 x="0px" y="0px"
                 width="127.433px" height="132.743px" viewBox="0 0 127.433 132.743" style={{opacity: 0.5}}
            >
                <path fill="#FFFFFF" d="M116.223,125.064c1.032-1.183,1.323-2.73,1.391-3.747V54.76c0,0-4.625-34.875-36.125-44.375
        ...
        c-0.007,0.007-0.015,0.014-0.021,0.02C71.666,63.771,71.892,63.307,71.916,62.782z"/>
                <circle fill="#FFFFFF" stroke="#f0f0f0" strokeMiterlimit="10" cx="18.614" cy="99.426" r="3.292"/>
                <circle fill="#FFFFFF" stroke="#f0f0f0" strokeMiterlimit="10" cx="95.364" cy="28.676" r="3.291"/>
                <circle fill="#FFFFFF" stroke="#f0f0f0" strokeMiterlimit="10" cx="24.739" cy="93.551" r="2.667"/>
                <circle fill="#FFFFFF" stroke="#f0f0f0" strokeMiterlimit="10" cx="101.489" cy="33.051" r="2.666"/>
                <circle fill="#FFFFFF" stroke="#f0f0f0" strokeMiterlimit="10" cx="18.738" cy="87.717" r="2.833"/>
                <path fill="#FFFFFF" stroke="#f0f0f0" strokeMiterlimit="10" d="M116.279,55.814c-0.021-0.286-2.323-28.744-30.221-41.012
        ...
        <div key="2" id="toasts" className="pt-2 pr-2" style={{position: "absolute", top: 0, right: 0, width: "350px"}}>
            <Notifications/>
        </div>,

        <div key="3" className="container-fluid bg-dark bottom-bar">
            <div className="row h-100 p-2 align-items-center">
                <div className="col-3">
                    <img className="halloween-shadow-invert" src="/images/Koornbeurslogo zonnebril klein.svg"
                         height="34px"
                         width="auto" alt="Logo"/>
                </div>
                <div id="middle-text" className="col-6 text-center text-white">
                    <CSSTransition in={fadeIn} timeout={2000} classNames="my-node">
                        {middleText}
                    </CSSTransition>
                </div>
                <div className="col-3 text-right">
                    <h3 id="clock" className="text-white mb-0 text-monospace halloween-shadow">
                        <Clock/>
                    </h3>
                </div>
            </div>
